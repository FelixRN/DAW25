...
-- Lista el nombre de los productos, el precio en dolares
select nombre, (precio*1.34) as precio_dolares from producto;
...
-- Devuelve una lista con el nombre de todos los productos que contienen la cadena Monitor en el nombre y tienen un precio inferior a 225 euros
select * from fabricante where nombre like "%Portatil%" and precio <225;
