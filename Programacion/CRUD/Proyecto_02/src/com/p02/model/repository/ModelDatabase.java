...
import com.p02.model.entities.Car;
	...
	public class ModelDatabase implements IModel {
	    ...
	    public void delete(String plate) {
	        String sql = "DELETE FROM Prueba1 WHERE plate = ?";
	    ...
	    public void updateCar(String plate, Car modifiedCar) {
	        String sql = "UPDATE Prueba1 SET plate = ?, model = ? WHERE plate = ?";

	        try (Connection conn = DataConnection.getConnection();
	             PreparedStatement pstmt = conn.prepareStatement(sql)) {
	            pstmt.setString(1, modifiedCar.getPlate());
	            pstmt.setString(2, modifiedCar.getModel());
	            pstmt.setString(3, plate); // El tercer parámetro es 
	            //necesario para la cláusula WHERE, que identifica qué registro se debe actualizar en la base de datos.
	            pstmt.executeUpdate();
	        } catch (SQLException e) {
	            e.printStackTrace();
	        }
	    ...
	    public void deleteList() {
	        String sql = "DELETE FROM Prueba1";
